...
8. **Fail-Operational Architecture**
...
2. **Create Safety Argumentation Series** (3 cheatsheets)
...
3. **Create Fault Handling Architecture Series** (3 cheatsheets)
...
4. **Create Quality Attributes Series** (4 cheatsheets)
...
5. **Create Missing Standards** (3 cheatsheets)
...
6. **Create Modern Practices Series** (2 cheatsheets)
