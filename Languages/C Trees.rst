...
🛡️ 4. Iterative Traversals (safer – no stack overflow risk)
...
⚙️ 5. Binary Search Tree (BST) – Core Operations
...
⚙️ 6. Binary Heap (Priority Queue) – Very common in embedded schedulers
...
⚙️ 7. Quick Decision Table – Which Tree/Structure in Embedded C?
