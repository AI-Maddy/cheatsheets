...
1. **PASTA Framework** - Process for Attack Simulation and Threat Analysis
...
1. **Attack Trees** - Visual representation with aircraft examples
2. **Threat Actor Profiles**
   - Casual/Coincidental (SAL 1)
   - Intentional/Simple (SAL 2)
   - Sophisticated/Determined (SAL 3)
1. **Aircraft-Specific Threats**
   - IFE exploits (buffer overflows, privilege escalation)
   - Wi-Fi MITM attacks
   - USB malware introduction
   - Supply chain compromises
1. **Mitigation Strategies** - Countermeasures per threat category
2. **Exam Questions** (5)
3. **Completion Checklist & Key Takeaways**
...
1. **Decision Frameworks**
   ...
   - Trade-off analysis
   - Consensus building
1. **Leading Architecture Review Boards**
2. **Exam Questions** (5)
3. **Completion Checklist & Key Takeaways**
...
1. **Smart Pointers Best Practices**
2. **Move Semantics for Performance**
3. **Exam Questions** (5)
4. **Completion Checklist & Key Takeaways**
...
1. **Embedded Debian/Ubuntu**
   - Debootstrap for minimal rootfs
   - Package management (apt)
   - Customization strategies
1. **Buildroot vs Yocto Comparison**
...
1. **Kernel Configuration**
   ...
   - Driver selection
1. **Real-Time Patches (PREEMPT_RT)**
2. **Exam Questions** (5)
3. **Completion Checklist & Key Takeaways**
...
1. **APEX API** (Application Executive)
...
1. **OCSP** (Online Certificate Status Protocol)
   ...
   - OCSP stapling
1. **2026 Certificate Expiration Crisis**
